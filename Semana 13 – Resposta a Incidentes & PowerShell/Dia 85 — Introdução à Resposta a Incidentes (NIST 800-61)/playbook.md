...
3. Procedimento de bloqueio documentado (firewall, IPS, fail2ban).
4. Lista de usuários e ativos críticos previamente definida.
5. Modelo de comunicação e relatório para registro e escalonamento do incidente.
